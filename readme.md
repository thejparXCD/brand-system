...
```js
const { Button, PillarCard, Stat } = window.CelebrationOnPointDesignSystem\\\_2fb49a;
```

**UI kits** (`ui\\\_kits/<product>/`)
...
**\*\*Generated (do not edit):\*\* `\_ds\_bundle.js`, `\_ds\_manifest.json`, `\_adherence.oxlintrc.json`.**---
