const MAP = {
  info: ['rgba(40,150,210,0.10)', 'var(--c-info)'],
  success: ['rgba(31,157,107,0.10)', 'var(--c-success)'],
  warning: ['rgba(232,146,12,0.12)', 'var(--c-warning)'],
  danger: ['rgba(220,75,75,0.10)', 'var(--c-danger)'],
};
      ...
      <span style={{ display: 'flex', color: accent, flex: 'none', marginTop: 1 }}>
        {icon || (
          <svg
            ...
            aria-hidden="true"
            dangerouslySetInnerHTML={{ __html: ICONS[tone] || ICONS.info }}
          />
        )}
      </span>
      <div style={{ flex: 1 }}>
        ...
        {children && (
          <div style={{ fontFamily: 'var(--font-body)', fontSize: 13.5, lineHeight: 1.5, color: 'var(--text-body)' }}>
            {children}
          </div>
        )}
      </div>
