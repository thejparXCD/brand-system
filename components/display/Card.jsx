...
export function Card({
  ...
  const tones = {
    ...
    ink: { background: 'var(--c-ink)', border: '1px solid rgba(255,255,255,0.10)', color: 'rgba(255,255,255,0.72)' },
  };
  const t = tones[tone] || tones.light;
  const shadow = { none: 'none', sm: 'var(--shadow-sm)', md: 'var(--shadow-md)', lg: 'var(--shadow-lg)' }[elevation] || 'var(--shadow-md)';
  return (
    <div
      style={{
